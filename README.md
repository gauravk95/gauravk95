...
* **Performance**: Improved crash-free rates to **99.9%** and optimized app sizes by up to **56%** through advanced modularization and R8.

---

### 🛠️ Technical Stack

* **Mobile & Architecture**: Android (Kotlin, Java), Jetpack Compose, MVI/MVVM, Clean Architecture, Multi-module DFM.
* **Media & Realtime**: WebRTC, ExoPlayer, FFmpeg (JNI), MediaCodec, Camera APIs, OpenGL Shaders.
* **Systems & Backend**: GraphQL (Schema Design), Spring Boot, Node.js, Distributed Systems, BFF, OAuth.
* **AI & Productivity**: GenAI-assisted workflows, AI Mock Servers, ML-driven content creation.
...
* **Email**: [gauravkcs50@gmail.com](mailto:gauravkcs50@gmail.com)
* **LinkedIn**: [linkedin.com/in/gauravk95/](https://linkedin.com/in/gauravk95/)
* **Open Source**: [Bubble Navigation](https://github.com/gauravk95) (1.8k ⭐), [Audio Visualizer](https://github.com/gauravk95) (900 ⭐)
